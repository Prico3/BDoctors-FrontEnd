...
<template>
    ...
    <div class="container my-5">
        ...
        <footer class="bg-light text-center text-white">
            ...
            <div class="container p-4 pb-0">
                ...
                <section class="mb-4">
                    ...
                    <a class="btn btn-primary btn-floating m-1" style="background-color: #3b5998;"
                        href="https://it-it.facebook.com/" role="button"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <a class="btn btn-primary btn-floating m-1" style="background-color: #dd4b39;"
                        href="https://www.google.it/" role="button"><i class="fab fa-google"></i></a>
            ...
            <!-- Copyright -->
            <div class="text-center p-3 rounded" style="background-color: #55AFFF;">
                © 2023 Copyright:
                <a class="text-white" href="#top">BDoctors</a>
            </div>
            <!-- Copyright -->
        </footer>
